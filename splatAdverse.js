...
function SplatAdverse(splatTexture) {
...
SplatAdverse.prototype.shader = function() {
    return splatShader;
}
...
SplatAdverse.prototype.setPosition = function(x,y,z) {
    this.position = [x,y,z];
}

SplatAdverse.prototype.setParameters = function(elapsed) {
...
SplatAdverse.prototype.sendUniformVariables = function() {
...
SplatAdverse.prototype.draw = function() {
    // dessin du splat 
    if(this.loaded) {
	gl.bindVertexArray(this.vao);
...
SplatAdverse.prototype.clear = function() {
